...
class CM1PostgresCardJob2(gym.Env):
  ...
  def __init__(self):
    ...
    #self.sql_query = list(open('/home/rl_project/agents/queries/job_queries_simple_test_7400.txt'))
    #self.sql_query = list(open('/home/rl_project/agents/queries/job_queries_simple_rejoin_test.txt'))
    self.sql_query = list(open('/home/rl_project/agents/queries/crossval_sens/job_queries_simple_crossval_2_test.txt'))
  ...
  def reset(self):
    ...
    #sql_query = random.choice(list(open('/home/rl_project/agents/queries/job_queries_simple_train_7400.txt'))).replace(";","")
    #sql_query = random.choice(list(open('/home/rl_project/agents/queries/job_queries_simple_rejoin_train.txt'))).replace(";", "")
    #sql_query = random.choice(list(open('/home/rl_project/agents/queries/crossval/job_queries_simple_crossval_7400_0_train_sort_a.txt'))).replace(";", "")
    #sql_query = random.choice(list(open('/home/rl_project/agents/queries/crossval_sens/job_queries_simple_crossval_2_train.txt'))).replace(";", "")
