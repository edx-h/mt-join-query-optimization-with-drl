...
class CM1PostgresCardJob1(gym.Env):
  ...
  def __init__(self):
    ...
    self.sql_query = list(open('/home/rl_project/agents/queries/crossval_sens/job_queries_simple_crossval_1_test.txt'))
  ...
  def reset(self):
    ...
    #sql_query = random.choice(list(open('/home/rl_project/agents/queries/crossval_sens/job_queries_simple_crossval_1_train.txt'))).replace(";", "")
