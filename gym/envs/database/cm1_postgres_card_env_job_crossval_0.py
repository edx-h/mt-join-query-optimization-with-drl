...
class CM1PostgresCardJob0(gym.Env):
  ...
  def __init__(self):
    ...
    self.sql_query = list(open('/home/rl_project/agents/queries/crossval_sens/job_queries_simple_crossval_0_test.txt'))
  ...
  def reset(self):
    ...
    #sql_query = random.choice(list(open('/home/rl_project/agents/queries/crossval_sens/job_queries_simple_crossval_0_train.txt'))).replace(";", "")
